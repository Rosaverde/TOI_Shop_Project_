    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("Customer", policy => policy.RequireAssertion(context => context.User.HasClaim("Role", "Customer") || context.User.HasClaim("Role","Admin")));
            });

            services.AddRazorPages(options =>
            {
                options.Conventions.AuthorizeFolder("/Admin", "Admin");
                options.Conventions.AuthorizePage("/Accounts/Payment", "Customer");
