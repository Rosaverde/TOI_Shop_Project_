...
namespace Shop.Application.Cart
{
    public class GetOrder
    {
        ...
        public Response Do()
        {
            ...
            var listOfProducts = _ctx.Stock.Include(x => x.Product).AsEnumerable().Where(x => cartList.Any(y => y.StockId == x.Id))
            ...
            var customerInfoString = _session.GetString("costumer-info");
